...
class CarDrivingData:
    ...
    ,gps_time:datetime,longitude:float,latitude:float,speed:float,direction:float,star_numbers:int):
        self.id = id
...
def __read_car_driving_data(file_name:str)->[CarDrivingData]:
    ...
    while True:
        ...
        car_info = CarDrivingData(id,control_label,business_status,passenger_status,light_status,road_status,break_status,reserved_words,receive_date,gps_time,longitude,latitude,speed,direction,star_numbers)
